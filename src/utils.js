...
export const getFiveFakeProducts = () => {
    let products = [];
    for (let i = 0; i < 5; i++) {
        products.push({
            id:i+1,
            ...
            foto:faker.image.animals(200, 600, true)
        })
    }
    return products;
}

export const normalizeUtils = (info)=>{
    // console.log(info);
    const authors = new schema.Entity('author',{},{idAttribute:'_id'});
    ...
    const normalizedObject = normalize(info,parentObject)
